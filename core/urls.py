...
urlpatterns = [
    ...
    path('<str:island>/posts/', views.post_list, name='posts'),
    path('<str:island>/post/<str:post_slug>/', views.post_detail, name='post'),
    path('<str:island>/top-activities/', views.view_bookings, name='bookings'),
    path('<str:island>/', views.view_island, name='change-island'),
    path('<str:island>/logout/', views.logout_admin, name='logout'),
    # path('<str:island>/top-beaches/', views.view_beaches, name='beaches'),
